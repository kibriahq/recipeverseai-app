...
const Navbar = () => {
    return (
        <nav className='fixed top-0 left-0 z-50 w-full bg-white/10 backdrop-blur-lg border-b border-surface/20'>
            <div className="container mx-auto h-20 flex items-center justify-between text-primary-text">
                ...
                <ul className="flex items-center justify-bwteen gap-10 text-md">
                    ...
                    <li>
                        <Link className="text-primary-text hover:text-primary transition-all" href="/explore">Explore</Link>
                    </li>
                    <li>
                        <Link className="text-primary-text hover:text-primary transition-all" href="/profile">Profile</Link>
                    </li>
                    <li>
                        <Link href="/login">
